...
export type OrchestratorStatus = { is_running: boolean, repos: Array<string>, runs: Array<AgentRun>, config: RunConfig, total_completed: number, total_failed: number, active_count: number, total_input_tokens: number, total_output_tokens: number, total_cost_usd: number, total_runtime_secs: number, };
